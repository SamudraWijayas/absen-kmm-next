      ...
      >
        <div>
          {isLoadingMessage ? (
            ...
            <div
              ref={scrollRef}
              className="flex flex-col space-y-3 pt-4 lg:pb-5 pb-14 overflow-y-auto h-[calc(100vh-5rem)] scrollbar-hide "
            >
            ...
            >
              <Controller
                ...
                render={({ field }) => (
                  <div
                    className={cn(
                      "w-full flex items-center gap-2 px-3 py-2 dark:bg-gray-900 rounded-full",
